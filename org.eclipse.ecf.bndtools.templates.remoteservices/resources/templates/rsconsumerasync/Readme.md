##Sync Remote Service Consumer Project
...
imported by the ECF generic provider.  

The imported remote service method may then be called by issuing a gogo 
command like this:

```console
g! helloasync MYNAME
HelloAsyncService responds: Hello Async to MYNAME
```
