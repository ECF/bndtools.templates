...
The EXPORT_REGISTRATION means that the HelloService has been exported by the ECF generic provider and 
...
There is also a Sync Consumer project template that can be used to create a consumer.
