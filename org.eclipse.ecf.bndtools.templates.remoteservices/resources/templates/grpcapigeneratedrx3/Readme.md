##gRPC Remote Services API Project

The project has a single proto file (in [protofiles/health.proto](./protofiles/health.proto)) that defines a 'HealthCheck' service
