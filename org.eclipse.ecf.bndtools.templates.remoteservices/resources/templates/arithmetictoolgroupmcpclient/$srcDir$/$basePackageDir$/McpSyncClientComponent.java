...
public class McpSyncClientComponent {
	...
	private static final String ARITHMETIC_TOOLS_NAME = "$api_package$.math.ArithmeticTools.%s";
	private static final String ADD_TOOL_NAME = String.format(ARITHMETIC_TOOLS_NAME, "add");
	private static final String MULTIPLY_TOOL_NAME = String.format(ARITHMETIC_TOOLS_NAME, "multiply");
