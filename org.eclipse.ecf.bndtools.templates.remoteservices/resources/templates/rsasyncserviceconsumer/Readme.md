##Async Remote Service Consumer Project

To start this project

To run a framework to export the Async Remote Service Impl
...
When the callasync command is given in the gogo shell, it will result in calling the consumer's 
