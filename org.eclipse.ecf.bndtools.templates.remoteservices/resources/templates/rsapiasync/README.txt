Readme for Async API Project

This project results from using the Async API project template to create a project.  This API project 
...
To export an implementation of this service, it's necessary to create another project with the Async Impl
project template.   To import and use the service, you need to create a consumer project with the
Async Consumer project template.   The impl and consumer project templates are both available from 
