...
// Define a toolgroup from the $serviceName$Service class. The default name
// for this toolgroup will be the class name i.e. $serviceName$Service unless
// overridden by providing an explicit name
@McpToolGroup(title = "$serviceName$Service", description = "Arithmetic operations exposed as mcp tools")
